...
bool UIVInventoryComponent::LoadAndAddItem(FPrimaryAssetId TargetItemId, uint8 Amount)
{
	...
	FStreamableDelegate Delegate = FStreamableDelegate::CreateUObject(
		this, &UIVInventoryComponent::AddItemOnLoadCompleted, TargetItemId, Amount);
...
bool UIVInventoryComponent::RemoveItemFromInventory_Implementation(FPrimaryAssetId ItemIdToRemove, uint8 Amount,
                                                                   int& Rest)
{
	UMedurvalAssetManager* AssetManager = Cast<UMedurvalAssetManager>(UMedurvalAssetManager::GetIfValid());
